  ...
  <layout>
      ...
      <tabs>
            ...
            <tab>
                ...
                <label>Mobile</label>
                <gadgets>
                    <gadget>/3rdpartygadget/files/Cumulus/CumulusMobile/gadget.xml</gadget>
                </gadgets>
            </tab>
            <tab>
                <id>ECE</id>
                <icon>persistent-chat</icon>
                <label>Chat and Email</label>
                <gadgets>
                    <gadget>https://cceeceweb.dcloud.cisco.com/system/templates/finesse/gadget/agent/ece.xml</gadget>
                </gadgets>
            </tab>
            <tab>
                <id>KB</id>
                <icon>report-view</icon>
                <label>Solve</label>
                <gadgets>
                    <gadget>https://cceeimwim.dcloud.cisco.com/system/templates/finesse/gadget/solve/solve.xml</gadget>
                </gadgets>
            </tab>
            <tab>
                <id>CB</id>
                <icon>web-sharing</icon>
                <label>Cobrowse</label>
                <gadgets>
                    <gadget>https://cceeimwim.dcloud.cisco.com/system/templates/finesse/gadget/cobrowse/cobrowse.xml</gadget>
                </gadgets>
            </tab>
            <tab>
                <id>Tasks</id>
                ...
                <label>Tasks</label>
                <gadgets>
                    <gadget>/3rdpartygadget/files/Cumulus/TaskManagement/TaskManagementGadget.xml?mrdid=5011&amp;mrdname=Tasks&amp;maxdialogs=3&amp;interruptAction=ACCEPT&amp;dialogLogoutAction=CLOSE</gadget>
                </gadgets>
            </tab>
            <tab>
                <id>Certification</id>
                ...
                <gadgets>
                    <gadget>/3rdpartygadget/files/Cumulus/PQTraining/gadget.xml</gadget>
                </gadgets>
            </tab>
            <tab>
                <id>SMS</id>
